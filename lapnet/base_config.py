...
def default() -> ml_collections.ConfigDict:
  ...
  cfg = ml_collections.ConfigDict({
      ...
      'use_x64': False,
      # multi-host is presently inactive
      # yet the framework exists to facilitate the utilization of multi-process environments 
      ...
      'mcmc': {
          ...
          'blocks':1,  # split electrons into blocks to perform mcmc update
      },
      'network': {
          'name':'lapnet',
          'detnet': {
          ...
          'envelope_type': 'abs-isotropic',  # Where does the envelope go?
